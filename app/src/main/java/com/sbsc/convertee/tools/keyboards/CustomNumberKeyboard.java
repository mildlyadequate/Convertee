...
public class CustomNumberKeyboard extends CustomKeyboard implements View.OnClickListener, View.OnLongClickListener {
    ...
    private void init( Context context ) {
        ...
        // Check locale
        if( Calculator.locale == Locale.UK ){
            mButtonComma.setText("");
            mButtonComma.setEnabled(false);
        }else if ( Calculator.locale == Locale.GERMANY){
            mButtonPeriod.setText("");
